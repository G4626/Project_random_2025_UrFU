# В v12 ПЕРЕПИШИ MCU НА АДЕКВАТНЫЕ
# DONE
# В v13 ПЕРЕДЕЛАЙ ПОД ПРИБЛИЖЕНИЕ ДО err=1%
# И ОПТИМИЗИРУЙ РАСЧЁТ РАССТОЯНИЯ
...
data_ = open('project_data_4_r1_N101_MCS100_j12.txt', 'w') # СЮДА ПИХАТЬ ИМЯ ФАЙЛА_ВЫВОДА
